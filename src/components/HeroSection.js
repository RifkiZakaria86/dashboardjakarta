  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        {/* Logo */}
        <div
          className={`flex justify-center mb-8 transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          <div className="relative w-24 h-24 rounded-2xl overflow-hidden bg-white/10 border border-white/20 shadow-2xl shadow-blue-500/30 p-2">
            <Image src="/logo.png" alt="WIKA Beton" fill className="object-contain p-2" />
          </div>
        </div>

        {/* Badge */}
        <div
          className={`flex justify-center mb-6 transition-all duration-1000 delay-100 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
        ...
        {/* Heading */}
        <h1
          className={`text-5xl sm:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight transition-all duration-1000 delay-200 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          Dashboard Stok
        ...
        {/* Subtitle */}
        <p
          className={`text-lg sm:text-xl text-blue-200/80 max-w-2xl mx-auto mb-12 leading-relaxed transition-all duration-1000 delay-300 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
        ...
        {/* Total All Regions Card */}
        <div
          className={`inline-block mb-12 transition-all duration-1000 delay-400 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
        ...
        {/* CTA Buttons */}
        <div
          className={`flex flex-wrap justify-center gap-4 transition-all duration-1000 delay-500 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          <a
            href="#wilayah"
        ...
        {/* Stats row */}
        <div
          className={`grid grid-cols-3 gap-6 max-w-lg mx-auto mt-20 transition-all duration-1000 delay-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          {[
